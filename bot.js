...
function tweet(){
    var params=[{q: '@screenrant',count: 1},{q: '@CinemaBlend',count: 1},{q: '@IMDb',count: 1},{q: '@CBR',count: 1},{q: '@movieweb',count: 1},{q: '@comingsoonnet',count: 1},{q: '@darkhorizons',count: 1},{q: '@Collider',count: 1},{q: '@RottenTomatoes',count: 1}];
